...
namespace UI
{
    public class LobbyMainPanel : MonoBehaviourPunCallbacks
    {
        ...
        public override void OnDisable()
        {
            ...
            CancelButton.onClick.RemoveListener(OnBackButtonClicked);
            BackButton.onClick.RemoveListener(OnBackButtonClicked);
            CreateRoomButton.onClick.RemoveListener(OnCreateRoomButtonClicked);
            RandomRoomButton.onClick.RemoveListener(OnJoinRandomRoomButtonClicked);
        ...
        public override void OnJoinedRoom()
        {
            ...
            foreach (Player p in PhotonNetwork.PlayerList)
            {
                ...
                if (p.CustomProperties.TryGetValue(SnakeGame.PLAYER_READY, out isPlayerReady))
                {
            ...
            {
                { SnakeGame.PLAYER_LOADED_LEVEL, false }
            };
        ...
        public override void OnPlayerPropertiesUpdate(Player targetPlayer, Hashtable changedProps)
        {
            ...
            {
                object isPlayerReady;
                if (changedProps.TryGetValue(SnakeGame.PLAYER_READY, out isPlayerReady))
                {
                    entry.GetComponent<PlayerListEntry>().SetPlayerReady((bool)isPlayerReady);
                }
            }
        ...
        public void OnCreateRoomButtonClicked()
        {
            ...
            roomName = (roomName.Equals(string.Empty)) ? "Room " + Random.Range(0, 1000) : roomName;
